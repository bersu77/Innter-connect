...
async function seed() {
  ...
  // Each role gets messages about THEIR workspace. Earlier seeds used a single
  // student-flavoured pool ("Your application…", "Your supervisor…") for every
  // recipient, which made companies/universities/admins see student-shaped
  // notifications. Each role now has its own pool.
  const ROLE_NOTES = {
    student: [
